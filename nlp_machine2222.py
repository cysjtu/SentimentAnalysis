...
def learn_model(data,target):
    ...
    print "statue 6857"
    print state
    data_train,test_data_tmp,target_train,test_target_tmp = cross_validation.train_test_split(data,target,test_size=0.1,random_state=state)
    ...
    print "begin predict"
    #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    test_data,test_ids=load_test_file("task2input.xml")
    ...
    save_predict(test_data, test_ids, result, "task2output.xml")
